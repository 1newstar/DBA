...
#																		#
#	MySQL性能检测脚本													#
#	作者: Matthew Montgomery											#
#	remark: BoobooWei													#
#	Bug提交网址: https://bugs.launchpad.net/mysql-tuning-primer			#
...
# 		mem, memory : 	检查内存使用勤快								#
#		disk, file :	检查磁盘和IO情况								#
#		innodb :		检查innodb相关的情况							# 
#		misc : 			检查慢查询,二进制日志，连接情况，后台线程等情况	#
#########################################################################
...
cecho "         -- MYSQL数据库性能检测报告--    " boldblue
cecho "              驻云科技DBA组                      " black
date_now=`date +"%F %H:%M:%S"`
echo 
echo
cecho "报告时间： $date_now" boldblue
